package org.academiadecodigo.tropadelete.BadBuilder;
...
public class Soup {
    ...
    public Soup(String chef, String soupName, String ingredients, double amountOfVegetables, double salt, double spiceAmount) {
        this.chef = chef;
